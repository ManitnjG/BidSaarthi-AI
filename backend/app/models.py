...
class BusinessDNA(BaseModel):
 categories:list[str]=Field(default_factory=list); states:list[str]=Field(default_factory=list); turnover:Optional[float]=None; has_gst:bool=False; has_udyam:bool=False; keywords:list[str]=Field(default_factory=list)
